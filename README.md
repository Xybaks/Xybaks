...
### 4. 💬 [Powerful TodoList](https://github.com/Xybaks/todoList)-  TypeScript, CSS, Redux, Hooks, Material UI,tests. StoryBook. Unfinished project: work with a server using the REST API will be added. The project is published on [gh-pages](https://Xybaks.github.io/counter2). I’m currently working on ...
### 5. 🔭 [Social Network](https://github.com/Xybaks/todoList)-  TypeScript, Redux, Hooks, REST API. Unfinished project, I’m currently working on ...
